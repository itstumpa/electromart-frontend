...
export const createBrand = (data: { name: string; slug?: string; logo?: string; description?: string }) => {
  return api.post<ApiResponse<BrandDto>>("/brands", data);
};

export const updateBrand = (id: string, data: { name?: string; slug?: string; logo?: string; description?: string }) => {
