...
const FALLBACK_COVER = 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&q=80';
const FALLBACK_LOGO  = 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&q=80';
          ...
          {vendors.map((vendor) => (
            ...
            >
              ...
              <div className="pt-7 pb-4 px-4">
                ...
                {vendor.specialty && (
                  <p className="text-xs text-slate-400 font-medium mb-3 leading-tight">{vendor.specialty}</p>
                )}
