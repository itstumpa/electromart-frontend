...
const floatingProducts = [
  {
    ...
    reviews: 2340,
    image:
      "https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=120&q=80",
  },
  {
    name: "Galaxy Watch 6",
    price: "৳42,999",
...
const stagger = {
  hidden: {},
  visible: {
    transition: { staggerChildren: 0.08, delayChildren: 0.2 } as const,
  },
};
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-6 items-center min-h-[78vh] py-3 md:py-0">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 order-2 lg:order-1">
              ...
              <motion.div
                ...
                className="flex flex-wrap items-center gap-4 sm:gap-8 pt-4 border-t border-amber-200/50 mt-2"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xl sm:text-3xl font-black text-foreground tabular-nums">
                      {customers.toLocaleString()}+
                    </p>
                    <p className="text-sm sm:text-lg text-foreground-muted font-medium">
                      Happy Customers
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-md lg:max-w-lg aspect-square">
                ...
                <motion.div
                  ...
                  className="absolute top-2 -right-1 sm:top-6 sm:-right-4 z-20 scale-75 sm:scale-100 origin-top-right"
                >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-2 -left-1 sm:bottom-6 sm:-left-6 z-20 scale-75 sm:scale-100 origin-bottom-left"
                >
              ...
              <div className="p-4 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <button
                      onClick={() => setCategory("")}
                      className={`text-left px-3 py-2 rounded-xl text-sm font-medium transition-colors ${!category ? "bg-amber-600 text-white" : "text-slate-600 hover:bg-amber-50"}`}
                    >
                      All Categories
                    </button>
                    {categories.map((cat) => (
                      <button
                        key={cat.id}
                        onClick={() => setCategory(cat.slug)}
                        className={`text-left px-3 py-2 rounded-xl text-sm font-medium transition-colors ${category === cat.slug ? "bg-amber-600 text-white" : "text-slate-600 hover:bg-amber-50"}`}
                      >
                        {cat.name}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <button
                      onClick={() => setBrand("")}
                      className={`text-left px-3 py-2 rounded-xl text-sm font-medium ${!brand ? "bg-amber-600 text-white" : "text-slate-600 hover:bg-amber-50"}`}
                    >
                      All Brands
                    </button>
                    {brands.map((b) => (
                      <button
                        key={b.id}
                        onClick={() => setBrand(b.id)}
                        className={`text-left px-3 py-2 rounded-xl text-sm font-medium ${brand === b.id ? "bg-amber-600 text-white" : "text-slate-600 hover:bg-amber-50"}`}
                      >
                        {b.name}
                      </button>
                    ))}
