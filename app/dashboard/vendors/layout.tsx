// SERVER COMPONENT — Vendor dashboard shell
...
export default function VendorDashboardLayout({ children }: { children: ReactNode }) {
  // Production: const user = await getServerSession(authOptions) → verify role === 'VENDOR'
  const user = mockUsers.find((u) => u.role === 'VENDOR')!;
  return (
