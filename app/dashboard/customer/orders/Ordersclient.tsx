        ...
        <div className="p-5 sm:p-6">
          ...
          {order.status === 'delivered' && (
            <Link href="/dashboard/customer/reviews"
              className="flex items-center justify-center gap-2 w-full mt-4 bg-amber-600 hover:bg-amber-700 text-white font-bold text-sm py-3 rounded-xl transition-colors"
            >
