...
export const updateStoreSettings = (id: string, data: UpdateStoreSettingsDto) => {
  return api.patch<ApiResponse<MyStoreDto>>(`/stores/${id}/settings`, data);
};
...
export const getAllStores = () => {
  return api.get<ApiResponse<StoreDto[]>>('/stores');
};
